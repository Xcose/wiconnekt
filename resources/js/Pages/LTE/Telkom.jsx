...
function Telkom({ items }) {
    return (
        <GuestLayout>
            <Head title="Telkom LTE" />
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="text-center">
                                    <p className="fs-4">Telkom LTE Packages</p>
                                </div>
                                <hr className="my-4" />
                                <p className="text-muted fs-5">
                                    PURE UNINTERRUPTED LTE. LTE is a wireless
                                    broadband technology that offers high speed
                                    connection for mobile devices and smart
                                    phones. Stay connected for as little as
                                    R6.95 per 1Gig.
                                </p>
                            </div>
