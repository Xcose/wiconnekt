...
import ImgVoip from "../../../images/Services/ServicePages/VoIPPage.png";
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <p className="text-muted fs-5">
                                    Say goodbye to unnecessary landline costs
                                    and only pay for the calls you make.
                                    Wiconnekt VoIP is perfect for anyone with
                                    Fibre or Fixed LTE who wants a home
                                    telephone number that is flexible,
                                    affordable and easy-to-use. It allows you to
                                    make low-cost calls to landline and mobile
                                    numbers, and free calls to other Wiconnekt
                                    VoIP numbers. To get connected you will
                                    need: An Internet connection, A Handset or
                                    Smartphone.
                                </p>
                            </div>
