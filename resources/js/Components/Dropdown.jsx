...
const Content = ({
    ...
    if (align === "left") {
        alignmentClasses =
            "ltr:tw-origin-top-left rtl:tw-origin-top-right start-0";
    } else if (align === "right") {
        alignmentClasses =
            "ltr:tw-origin-top-right rtl:tw-origin-top-left end-0";
    }
        ...
        <>
            ...
            >
                ...
                >
                    <div
                        className={
                            `rounded-md tw-ring-1 tw-ring-black tw-ring-opacity-5 ` +
                            contentClasses
                        }
                    >
                        {children}
